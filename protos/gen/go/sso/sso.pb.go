...
type SignInRequest struct {
	...
	Password      int32                  `protobuf:"varint,1,opt,name=password,proto3" json:"password,omitempty"`        // Пароль пользователя
...
func (x *SignInRequest) GetPassword() int32 {
	if x != nil {
		return x.Password
	}
	return 0
...
var file_sso_sso_proto_rawDesc = string([]byte{
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72,
