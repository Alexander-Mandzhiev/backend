...
import (
	...
	cfg "backend/services/locatuion_types/config"
	"backend/services/locatuion_types/handle"
	"backend/services/locatuion_types/repository"
	"backend/services/locatuion_types/service"
	"log"
	"log/slog"
	"os"
	"os/signal"
