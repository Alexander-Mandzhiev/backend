...
type LocationTypeProvider interface {
	Create(ctx context.Context, locationTypes *location_types.CreateLocationTypeRequest) (int32, error)
	Get(ctx context.Context, id int) (*location_types.LocationTypeResponse, error)
	Update(ctx context.Context, locationTypes *location_types.UpdateLocationTypeRequest) error
